            ...
            <div class="card card-style">
                <div class="content mb-0 mt-1">
                    ...
                    <div class="input-style has-icon input-style-1 input-required mt-4">
                        ...
                        <span>Cakada ID</span>
                        <x-text-input id="cakada_id" class="input" type="number" name="cakada_id" :value="old('cakada_id')" required placeholder="Cakada ID" />
                    ...
                    <div class="input-style has-icon input-style-1 input-required mt-4">
                        <i class="input-icon fa fa-bar-chart color-theme"></i>
                        <span>Apakah akan memilih calon tersebut ?</span>
                        <select id="elektabilitas" name="elektabilitas" class="input" required>
                            <option value="">Pilih Elektabilitas</option>
                    ...
                    <div class="input-style has-icon input-style-1 input-required mt-4">
                        ...
                        <span>Apakah boleh memasang atribut calon (stiker/brosur/pamflet dll)</span>
                    ...
                    <div class="input-style has-icon input-style-1 mt-4">
                        <i class="input-icon fa fa-comment color-theme"></i>
                        <span>Alasan memilih calon ?</span>
                        <x-text-input id="alasan" class="input" type="text" name="alasan" :value="old('alasan')" placeholder="Alasan" />
                    ...
                    <div class="input-style has-icon input-style-1 mt-4">
                        <i class="input-icon fa fa-comment color-theme"></i>
                        <span>Pesan Pemilih Untuk Calon</span>
                        <x-text-input id="pesan" class="input" type="text" name="pesan" :value="old('pesan')" placeholder="Pesan" />
                        <x-input-error :messages="$errors->get('pesan')" class="mt-2" />
                    </div>

                    <!-- Deskripsi -->
                    <div class="input-style has-icon input-style-1 mt-4">
                        <i class="input-icon fa fa-info-circle color-theme"></i>
                        <span>Deskripsi</span>
                        <x-text-input id="deskripsi" class="input" type="text" name="deskripsi" :value="old('deskripsi')" placeholder="kendala dilapanagan jika ada" />
                    ...
                    <div class="input-style has-icon input-style-1 mt-4">
                        <span>Longitude</span>
                        <x-text-input id="long" class="input" type="text" name="long" readonly :value="old('long')" />
