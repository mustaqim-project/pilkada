            ...
            <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                        ...
                        <div class="card-body d-flex align-items-end pt-0">
                            ...
                            <div class="d-flex align-items-center flex-column mt-3 w-100">
                                ...
                                <div class="h-8px mx-3 w-100 bg-white bg-opacity-50 rounded">
                                    <div class="bg-white rounded h-8px" role="progressbar" style="
                                                width: 72%;
                    ...
                    <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                        ...
                        <div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
                            ...
                            <div class="d-flex flex-column content-justify-center flex-row-fluid">
                                ...
                                <div class="d-flex fw-semibold align-items-center">
                                    <!--begin::Bullet-->
                                    <div class="bullet w-8px h-3px rounded-2 me-3" style="
                ...
                <div class="col-xxl-6">
                    ...
                    <div class="card card-flush h-md-100">
                        <!--begin::Body-->
                        <div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0" style="
                            ...
                            <div class="mb-10">
                                ...
                                <div class="fs-2hx fw-bold text-gray-800 text-center mb-13">
                                    <span class="me-2">Try our all new Enviroment with <br />
                        ...
                        <div class="card-body pt-6">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="kt_chart_widget_8_week_tab" role="tabpanel">
                                    ...
                                    <!--end::Statistics-->
                                    <!--begin::Chart-->
                                    <div id="kt_chart_widget_8_week_chart" class="ms-n5 min-h-auto" style="
                                                height: 275px;
                                            "></div>
                                    <!--end::Chart-->
                                    <!--begin::Items-->
                                ...
                                <div class="tab-pane fade active show" id="kt_chart_widget_8_month_tab" role="tabpanel">
                                    ...
                                    <!--end::Statistics-->
                                    <!--begin::Chart-->
                                    <div id="kt_chart_widget_8_month_chart" class="ms-n5 min-h-auto" style="
                                                height: 275px;
                                            "></div>
                                    <!--end::Chart-->
                                    <!--begin::Items-->
                        ...
                        <div class="card-body py-9">
                            ...
                            <div class="row gx-9 h-100">
                                ...
                                <div class="col-sm-6 mb-10 mb-sm-0">
                                    <!--begin::Image-->
                                    <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-400px min-h-sm-100 h-100" style="
                                                background-size: 100%
                                                    100%;
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="border border-gray-300 border-dashed rounded min-w-100px w-100 py-2 px-4 mb-3">
                                                    <!--begin::Number-->
                                                    <span class="fs-6 text-gray-700 fw-bold">$ <span class="ms-n1" data-kt-countup="true" data-kt-countup-value="284,900.00">0</span>
                                                    </span>
                                                    <!--end::Number-->
                                                    <!--begin::Label-->
